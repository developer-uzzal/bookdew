...
<template>
    ...
    <p style="height: 200px;" v-if="page.props.book == null" class="text-center">No books found</p>
        <div class="row align-items-center" v-if="page.props.book">
            <!-- Book Cover -->
        ...
        <!-- Related Books -->
        <div class="mt-5" v-if="page.props.relatedBooks.length > 0" >
            <h3>Related Books</h3>
            <div class="row">
